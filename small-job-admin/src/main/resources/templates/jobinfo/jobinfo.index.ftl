...
<body class="hold-transition skin-blue sidebar-mini <#if cookieMap?exists && cookieMap["smalljob_adminlte_settings"]?exists && "off" == cookieMap["smalljob_adminlte_settings"].value >sidebar-collapse</#if>">
<div class="wrapper">
	<!-- header -->
...
package com.small.job.service.handler;

import com.small.job.core.log.SmallJobLogger;
...
public class DemoGlueJobHandler extends IJobHandler {
	...
	public ReturnT<String> execute(String param) throws Exception {
		SmallJobLogger.log("SMALL-JOB, Hello World.");
...
#!/usr/bin/env node
console.log("small-job: hello nodejs")
...
Write-Host "small-job: hello powershell"
