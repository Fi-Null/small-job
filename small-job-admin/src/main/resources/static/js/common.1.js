$(function(){
	...
	$('.sidebar-toggle').click(function(){
		var smalljob_adminlte_settings = $.cookie('smalljob_adminlte_settings');	// on=open，off=close
		if ('off' == smalljob_adminlte_settings) {
            smalljob_adminlte_settings = 'on';
		} else {
            smalljob_adminlte_settings = 'off';
		}
		$.cookie('smalljob_adminlte_settings', smalljob_adminlte_settings, { expires: 7 });	//$.cookie('the_cookie', '', { expires: -1 });
	});
